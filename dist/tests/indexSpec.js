...
describe("Invalid width(NaN)", () => {
    it('returns 400 and Invalid width', () => __awaiter(void 0, void 0, void 0, function* () {
        return yield request.get(`/api/resize/?file=fjord&width=n&height=${testHeight}`).expect(400);
    }));
});
describe("Invalid width(negative number)", () => {
    it('returns 400 and Invalid width', () => __awaiter(void 0, void 0, void 0, function* () {
        return yield request.get(`/api/resize/?file=fjord&width=-1&height=${testHeight}`).expect(400);
    }));
});
describe("Invalid height(NaN)", () => {
    it('returns 400 and Invalid height', () => __awaiter(void 0, void 0, void 0, function* () {
        return yield request.get(`/api/resize/?file=fjord&width=${testWidth}&height=t`).expect(400);
    }));
});
describe("Invalid height(negative number)", () => {
    it('returns 400 and Invalid height', () => __awaiter(void 0, void 0, void 0, function* () {
        return yield request.get(`/api/resize/?file=fjord&width=${testWidth}&height=-1`).expect(400);
    }));
});
